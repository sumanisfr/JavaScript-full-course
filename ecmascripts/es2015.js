...
var myVavWorldBestName = "suman";
myVavWorldBestName = "sumanisfr";
console.log(myVavWorldBestName);
...
// multiple line string: Template strings can span multiple lines without the need for escape characters.

let multiLineString = `This is a 
multi-line string
no im suman kumar ghosh `;
